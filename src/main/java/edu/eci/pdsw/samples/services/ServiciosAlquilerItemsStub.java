...
//          IDItem x IDCliente
    ...
    private void poblar() throws ExcepcionServiciosAlquiler {
        ...
        Item i7=new Item(ti1, 7, "Los 4 Fantasticos", "Los 4 Fantásticos  es una película de superhéroes  basada en la serie de cómic homónima de Marvel.", java.sql.Date.valueOf("2005-06-08"), 2000, "DVD", "Ciencia Ficcion");
        Item i8=new Item(ti2, 8, "Halo 3", "Halo 3 es un videojuego de disparos en primera persona desarrollado por Bungie Studios.", java.sql.Date.valueOf("2007-09-08"), 3000, "DVD", "Shooter");
        Item i9=new Item(ti3, 9, "Thriller", "Thriller es una canción interpretada por el cantante estadounidense Michael Jackson, compuesta por Rod Temperton y producida por Quincy Jones.", java.sql.Date.valueOf("1984-01-11"), 2000, "DVD", "Pop");
        Item i10=new Item(ti1, 10, "Los 4 Fantasticos", "Los 4 Fantásticos  es una película de superhéroes  basada en la serie de cómic homónima de Marvel.", java.sql.Date.valueOf("2005-06-08"), 2000, "DVD", "Ciencia Ficcion");
        Item i11=new Item(ti2, 11, "Halo 3", "Halo 3 es un videojuego de disparos en primera persona desarrollado por Bungie Studios.", java.sql.Date.valueOf("2007-09-08"), 3000, "DVD", "Shooter");
        Item i12=new Item(ti3, 12, "Thriller", "Thriller es una canción interpretada por el cantante estadounidense Michael Jackson, compuesta por Rod Temperton y producida por Quincy Jones.", java.sql.Date.valueOf("1984-01-11"), 2000, "DVD", "Pop");
        ...
        Cliente c4=new Cliente("Laura Ramos", 1018489805, "4457663", "KRA 10#94-a77", "laura@hotmail.com");
        ...
        registrarAlquilerCliente(java.sql.Date.valueOf(LocalDate.now()), c1.getDocumento(), i1, 10);
        registrarAlquilerCliente(java.sql.Date.valueOf("2017-01-01"), c1.getDocumento(), i2, 40);
        registrarAlquilerCliente(java.sql.Date.valueOf("2017-03-07"), c2.getDocumento(), i3, 9);
        registrarAlquilerCliente(java.sql.Date.valueOf("2017-03-07"), c3.getDocumento(), i4, 9);
        registrarAlquilerCliente(java.sql.Date.valueOf("2017-03-07"), c4.getDocumento(), i5, 9);
        registrarAlquilerCliente(java.sql.Date.valueOf("2017-03-07"), c4.getDocumento(), i6, 9);
